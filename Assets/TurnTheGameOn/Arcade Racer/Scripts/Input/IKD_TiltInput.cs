...
namespace TurnTheGameOn.IKDriver {
	...
	public class IKD_TiltInput : MonoBehaviour{
		...
		private IKD_CrossPlatformInputManager.VirtualAxis m_SteerAxis;
		...
		private void Update(){
			...
			case AxisMapping.MappingType.MousePositionX:
				IKD_CrossPlatformInputManager.SetVirtualMousePositionX(axisValue*Screen.width);
				break;
			case AxisMapping.MappingType.MousePositionY:
				IKD_CrossPlatformInputManager.SetVirtualMousePositionY(axisValue*Screen.width);
				break;
			case AxisMapping.MappingType.MousePositionZ:
				IKD_CrossPlatformInputManager.SetVirtualMousePositionZ(axisValue*Screen.width);
				break;
			}
		}
...
namespace TurnTheGameOn.IKDriver{
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof (IKD_TiltInput.AxisMapping))]
