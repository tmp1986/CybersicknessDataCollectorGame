...
namespace TurnTheGameOn.IKDriver {
	public class IKD_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler	{
		...
		IKD_CrossPlatformInputManager.VirtualAxis m_VerticalVirtualAxis; // Reference to the joystick in the cross platform input
